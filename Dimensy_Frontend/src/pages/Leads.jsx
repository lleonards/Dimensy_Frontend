      ...
      <div className="card">
        {loading ? (
          ...
          <div className="text-center py-16 text-gray-400">
            ...
            <p className="text-lg font-medium">Ainda não há leads.</p>
            <p className="text-sm mt-2">
              Quando um cliente preencher o formulário da sua página,
              ...
              {leads.map((lead) => (
                <li key={lead.id}>
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-gray-300 flex-shrink-0 ml-3"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
