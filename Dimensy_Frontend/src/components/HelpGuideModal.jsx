...
const GUIDE_STEPS = [
  {
    ...
    description: 'O usuário usa as ferramentas da Dimensy, informa os dados e adiciona tudo o que precisar em cada etapa.'
  },
  {
    icon: Home,
  ...
  },
  {
    ...
    description: 'No resultado, a Dimensy mostra a norma utilizada e também o link para leitura e conferência da referência normativa.'
  }
];
      ...
      <div className="help-modal-card" onClick={(e) => e.stopPropagation()}>
        <div className="help-modal-header">
          <div>
            ...
            <h2>Como funciona a Dimensy</h2>
            <p>
              A Dimensy foi pensada para ser simples: você alimenta as ferramentas,
