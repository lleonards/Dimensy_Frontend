...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    const token = localStorage.getItem('dimensy_token');
    const savedUser = localStorage.getItem('dimensy_user');
  ...
  const login = async (email, password) => {
    ...
    localStorage.setItem('dimensy_token', res.data.access_token);
    localStorage.setItem('dimensy_refresh', res.data.refresh_token);
    localStorage.setItem('dimensy_user', JSON.stringify(res.data.user));
  ...
  const register = async (nome, email, password) => {
    ...
    localStorage.setItem('dimensy_token', loginRes.data.access_token);
    localStorage.setItem('dimensy_refresh', loginRes.data.refresh_token);
    localStorage.setItem('dimensy_user', JSON.stringify(loginRes.data.user));
